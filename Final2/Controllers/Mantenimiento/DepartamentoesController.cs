...
namespace Final2.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdDepartamento,CodigoDep,Nombre,Encargado")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdDepartamento,CodigoDep,Nombre,Encargado")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
